...
class MxGlass extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final base   = color ?? (isDark ? const Color(0xFF1A2E3E) : Colors.white);
    return ClipRRect(
    ...
    final card = Padding(
      ...
      child: ClipRRect(
        ...
        child: BackdropFilter(
          ...
          child: Container(
            decoration: BoxDecoration(
              color: base.withOpacity(isDark ? 0.45 : 0.60),
              borderRadius: BorderRadius.circular(radius),
        ...
        child: ClipRRect(
          ...
          child: BackdropFilter(
            ...
            child: Container(
              decoration: BoxDecoration(
                color: isDark
                    ? const Color(0xFF1A2E3E).withOpacity(0.72)
      ...
      child: ClipRRect(
        ...
        child: BackdropFilter(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: isDark
                  ? const Color(0xFF1A2E3E).withOpacity(0.75)
